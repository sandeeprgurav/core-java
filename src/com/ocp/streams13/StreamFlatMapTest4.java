...
public class StreamFlatMapTest4 {
...
// Ans: Stream.of(list1, list2).flatMap(list -> list.stream()).forEach(s -> System.out.print(s + " "));
// flatMapToInt requires param as InStream not Steam<Integer>  
